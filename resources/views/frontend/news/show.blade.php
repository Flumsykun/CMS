...
@section('frontend_content')
    <div class="bg-white px-6 py-32 lg:px-8">
        <div class="mx-auto max-w-5xl text-base leading-7 text-gray-700">
            {!! $template !!}
            {{--<p class="text-base font-semibold leading-7 text-voot-600">Introducing</p>--}}
            ...
            {{--            <svg class="mt-1 h-5 w-5 flex-none text-voot-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">--}}
            ...
            {{--    <figure class="mt-10 border-l border-voot-600 pl-9">--}}
