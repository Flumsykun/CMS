@component('frontend.components.homepage-block')
    <div class="mx-auto max-w-7xl">
        <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-3xl font-bold tracking-tight text-black sm:text-4xl">Content...</h2>
            <p class="mt-2 text-lg leading-8 text-gray-600">Sample text</p>
        </div>
        <div class="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            ...
            <article class="flex max-w-xl flex-col items-start justify-between">
                ...
                <div class="mt-10 flex items-center gap-x-6">
                    ...
                    <a href="{{ route('news.show', compact('newsPost')) }}" class="text-sm font-semibold leading-6 text-gray-900">Action btn <span aria-hidden="true">→</span></a>
                </div>
            </article>
            @endforeach
        </div>
