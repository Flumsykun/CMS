    ...
    <body>
        <div class="divide-y divide-gray-800">
            <nav class="flex items-center bg-gray-900 px-3 py-2 shadow-lg ">
                ...
                <div class="h-12 w-full flex items-center">
                    <a href="{{ url('/') }}" class="w-full">
                        <img class="h-8" src="{{ url('/img/youporn.svg')}}"/>
                    </a>
                </div>
                <div class="flex justify-end sm:w-8/12">
                    {{--Top Navigation--}}
                    <ul class="hidden sm:block sm:text-left text-gray-200 text-xl">
                        <a href="{{ url('login')}}">
                            <li class="cursor-pointer px-4 py-2 hover:underline">Login
                            </li>
                        </a>
                    </ul>
                </div>
            ...
            <div class="sm:flex sm:min-h-screen">
                ...
                <main class="bg-gray-100 p-12 min-h-screen sm:w-8/12 md:w-9/12 lg:w-10/12 flex flex-col">
